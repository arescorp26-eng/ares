...
export default function DashboardShell({ 
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row">
      {/* ─── Mobile Top Bar ─── */}
      <header className="lg:hidden sticky top-0 z-50 bg-surface/90 backdrop-blur-xl border-b border-surface-border px-4 py-3 flex items-center justify-between safe-top">
        <button 
          onClick={() => setSidebarOpen(true)}
          className="p-2 -ml-1 rounded-xl hover:bg-secondary/30 transition-colors"
        ...
        {sidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-0 bottom-0 w-72 max-w-[85vw] z-[70] bg-surface border-r border-surface-border p-5 flex flex-col lg:hidden shadow-2xl safe-top"
            >
      ...
      {/* ─── Desktop Sidebar ─── */}
      <aside className="hidden lg:flex w-64 xl:w-72 bg-surface border-r border-surface-border p-6 flex-col sticky top-0 h-screen z-40 shrink-0">
